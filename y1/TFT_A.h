...
//ส่วนของเมนู วัดระยะ
  ...
  tft.drawString("(A) Warning distance : 600 mm", 0, 70);   //ข้อความ
...
//เข้าเงื่อนไข
  ...
  delay(7000);
    ...
    Distance = 600; Serial.println("Auto distance = 800 mm"); delay(1000);
    tft.fillScreen(TFT_BLUE);
    tft.setTextColor(tft.color24to16(0xFFFFFF));        //สีข้อความ
    tft.setTextSize(3);                                 //ขนาดข้อความ
    tft.drawString("Auto distance = 600 mm", 40, 150);          //ข้อความ
    delay(7000);
  }
